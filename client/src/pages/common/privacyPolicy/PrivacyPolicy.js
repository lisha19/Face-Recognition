        ...
        <Layout className='home layout'>
            ...
            <Content>
                <Card>
                    ...
                    { <p>At  Be On Time, accessible from my git link  https://github.com/lisha19 .</p> }

                    <p>If you have additional questions or require more information about our site, do not hesitate to contact us.</p>

                    

                    <Title level={4}>what is face recogination attendance system</Title>

                    <p>Face Recognition Attendance System is an attendance system based on face recognition which automatically marks the attendance of the present employee on recognizing the face of an employee. Over the past years, attendance was done by calling the names or by signing the signature on the attendance paper</p>
                    ...
                    <p>Attendlytical follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p> */}
                     ...
                     {/* <img src="img.png"></img> */}
{/* 
                    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of  Be On Time.</p>

                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on  Be On Time, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</p>

                    <p>Note that  Be On Time has no access to or control over these cookies that are used by third-party advertisers.</p> */} 
